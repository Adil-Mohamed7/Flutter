...
final User user_1 = User(
    name: const Name(first: 'Rahul', last: 'Nair'),
...
final List<Email> emails = [
  Email(
    sender: user_1,
    recipients: [],
    subject: 'Gmeet with Friends',
    content:
        'Meet your friends for a get together this Friday evening at 5 pm. Join the group for more info.',
  ),
  Email(
    sender: user_2,
    recipients: [],
